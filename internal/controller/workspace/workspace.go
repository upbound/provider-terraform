...
func Setup(mgr ctrl.Manager, o controller.Options, timeout, pollJitter time.Duration) error {
	...
	c := &connector{
		...
		logger: o.Logger,
		fs:     fs,
		terraform: func(dir string, usePluginCache bool, enableLogging bool, envs ...string) tfclient {
			return terraform.Harness{Path: tfPath, Dir: dir, UsePluginCache: usePluginCache, EnableLogging: enableLogging, Envs: envs}
		},
	}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) { //nolint:gocyclo
	...
	tf := c.terraform(dir, *pc.Spec.PluginCache, cr.Spec.EnableLogging, envs...)
